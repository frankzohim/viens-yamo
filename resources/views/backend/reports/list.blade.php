...
@section('title')
Liste des messages de dénonciations
@endsection
                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active">Dénonciations</li>
                            </ol>
                        </div>
                        <h4 class="page-title">Liste des dénonciations</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
                                    ...
                                    <tbody>
                                        @if ($reports)
                                            ...
                                            <tr>
                                                ...
                                                <td><a href="apps-ecommerce-orders-details.html" class="text-body fw-bold">{{ $report['id'] }}</a> </td>
                                                <td>
                                                    <h5>{{ $report['name'] }}</h5>
                                                </td>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{ route('reports.edit',$report['id']) }}" class="action-icon"> <i class="mdi mdi-square-edit-outline"></i></a>
                                                    <a href="#" data-bs-toggle="modal" data-bs-target="#exampleModal{{$report['id']}}"
                                                        ...
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <form method="POST" action="{{ route('reports.delete',$report['id']) }}" id="delete-form{{$report['id']}}">
                                                                    @csrf
