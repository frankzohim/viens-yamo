                    ...
                    <div class="page-title-box">
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                ...
                                <li class="breadcrumb-item active">Éditer un contact</li>
                            </ol>
                        </div>
                        <h4 class="page-title">Éditer un contact</h4>
                    </div>
                </div>
            </div>
            <!-- end page title -->
                                ...
                                <div id="" >
                                    <div class="container">
                                        <div class="alert alert-success p-3  alert-dismissible fade show" role="alert">
                                            <strong><i class="fa fa-check mr-3"></i>  Super</strong> - le contact a été bien modifiée.
                                        </div>
                                    </div>
                                </div>
                                @endif
                            ...
                            <div class="tab-content">
                                <div class="tab-pane show active" id="input-types-preview">
                                            ...
                                            <form method="POST" action="{{ route('contacts.update') }}">
                                                ...
                                                <div class="col-lg-12">
                                                    <div class="mb-3">
                                                        <label for="simpleinput" class="form-label">Sujet</label>
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" name="message"  
                                                         class="form-control"  disabled
                                                        value="{{ $contact['message'] }}" required>
                                                    </div>
												 ...
												 <div class="mb-3">
                                                    <label for="example-email" class="form-label">Status</label>
                                                      <select name="statut" id="statut" class="form-control" required>
                                                          <option value="0" @if ($contact['status'] == 0) selected @endif>Non Traité</option>
                                                            <option value="1" @if ($contact['status'] == 1) selected @endif>Traité</option>
                                                      </select>
                                                </div>
